...
class Interceptor extends \Magento\Email\Block\Adminhtml\Template\Edit\Form implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getEmailTemplate');
        return $pluginInfo ? $this->___callPlugins('getEmailTemplate', func_get_args(), $pluginInfo) : parent::getEmailTemplate();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getVariables');
        return $pluginInfo ? $this->___callPlugins('getVariables', func_get_args(), $pluginInfo) : parent::getVariables();
    }
