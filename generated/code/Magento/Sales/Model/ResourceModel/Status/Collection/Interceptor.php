...
class Interceptor extends \Magento\Sales\Model\ResourceModel\Status\Collection implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function joinStates()
    {
        ...
        return $pluginInfo ? $this->___callPlugins('joinStates', func_get_args(), $pluginInfo) : parent::joinStates();
    }
    ...
    public function addStateFilter($state)
    {
        ...
        return $pluginInfo ? $this->___callPlugins('addStateFilter', func_get_args(), $pluginInfo) : parent::addStateFilter($state);
    }
    ...
    public function orderByLabel($dir = 'ASC')
    {
        ...
        return $pluginInfo ? $this->___callPlugins('orderByLabel', func_get_args(), $pluginInfo) : parent::orderByLabel($dir);
    }
