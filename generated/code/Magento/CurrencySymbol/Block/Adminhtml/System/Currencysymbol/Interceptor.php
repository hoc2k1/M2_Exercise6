...
class Interceptor extends \Magento\CurrencySymbol\Block\Adminhtml\System\Currencysymbol implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getCurrencySymbolsData');
        return $pluginInfo ? $this->___callPlugins('getCurrencySymbolsData', func_get_args(), $pluginInfo) : parent::getCurrencySymbolsData();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getInheritText');
        return $pluginInfo ? $this->___callPlugins('getInheritText', func_get_args(), $pluginInfo) : parent::getInheritText();
    }
